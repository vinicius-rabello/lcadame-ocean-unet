...
#####################################################################################
def EnKF1(ubi,observations,numericalState,H,N,M,Nlat,Nlon):
    ...
    # Convert the list of diagonals to a numpy array and flatten it
    # flattened_diagonals = np.array(diagonals).flatten()
    # print("\nFlattened Diagonals:")
    # print(flattened_diagonals)
    ...
    #============= SMW Inverse    ======================================
    # Inv=np.linalg.inv(D)
    # sInv=inverse_SMW(ubi,sig_m,R,Nlat,Nlon)
    # K=Pb@(sInv)

    # print("Difference between KK and K:\n", K - KK)
